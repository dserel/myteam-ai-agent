...
6b. **Ώρες σε UTC.** ΟΛΑ τα datetime (events.start_date, transaction_at, due_at κ.λπ.) είναι αποθηκευμένα σε **UTC**. Όταν επιστρέφεις ώρα/ημερομηνία ΓΙΑ ΕΜΦΑΝΙΣΗ στον χρήστη (π.χ. ώρα προπόνησης/αγώνα), τύλιξέ την σε `CONVERT_TZ(<col>, 'UTC', 'Europe/Athens')` ώστε να φαίνεται σε τοπική ώρα Ελλάδας. Για ΦΙΛΤΡΑ/συγκρίσεις άφησε το raw UTC.
